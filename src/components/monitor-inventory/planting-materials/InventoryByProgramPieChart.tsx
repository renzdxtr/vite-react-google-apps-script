...
export default function PM_InventoryProgramChart() {
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-white p-3 border rounded-lg shadow-lg max-w-xs">
          ...
          <p className="text-sm text-blue-600 mb-1">Volume: {data.volume.toLocaleString()}pcs</p>
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="items-center pb-0">
        <CardTitle>Inventory by Program</CardTitle>
        <CardDescription>Planting materials' quantity distribution by program</CardDescription>
      </CardHeader>
      <CardContent className="flex-1 pb-0">
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        ...
        <div className="leading-none text-muted-foreground">Showing total materials' quantity across all programs</div>
      </CardFooter>
    </Card>
  )
}
